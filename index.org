...
* Operating System
** My "Lynx"
*** The instruction to Lynx
    Lynx is an embedded operating system kernel just support for arm architecture cpu at present, it is in developing.
*** How to get the code
    you can get code frome:\\
    [[git@github.com:yannik520/Lynx.git]]\\
    or read code directly from:\\
    https://github.com/yannik520/Lynx
